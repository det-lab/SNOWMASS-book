...
%% IMPORTANT:   from this file, refer to the bibliography as   Accelerator/AF03/bibliography.tex   
%%    refer to a figure   A.pdf  as    Accelerator/AF03/figures/A.pdf  .

\chapter{Accelerators for Electoweak and Higgs Boson Processes}

\authorlist{G. Hoffstaetter, Q. Qin, M. Ross}
...
``No branch of Zoology is so much involved as that which is entitled Cetology,'' says Captain Scoresby, A.D. 1820~\cite{A3-Scoresby}.

``It is not my intention, were it in my power, to enter into the inquiry as to the true method of dividing the cetacea into groups and families. $\cdots$ Utter confusion exists among the historians of this animal'' (sperm whale), says Surgeon Beale, A.D. 1839~\cite{A3-Beale}.
...
%\bibliography{Accelerator/AF03/myreferences} 
...
\input Accelerator/AF03/bibliography.tex
