...
%% IMPORTANT:   from this file, refer to the bibliography as   Accelerator/AF05/bibliography.tex   
%%    refer to a figure   A.pdf  as    Accelerator/AF05/figures/A.pdf  .

\chapter{Accelerators for Fixed Target and Rare Processes}

\authorlist{R. Milner, E. Prebys, M. Lamont}
...
``No branch of Zoology is so much involved as that which is entitled Cetology,'' says Captain Scoresby, A.D. 1820~\cite{A5-Scoresby}.

``It is not my intention, were it in my power, to enter into the inquiry as to the true method of dividing the cetacea into groups and families. $\cdots$ Utter confusion exists among the historians of this animal'' (sperm whale), says Surgeon Beale, A.D. 1839~\cite{A5-Beale}.
...
%\bibliography{Accelerator/AF05/myreferences} 
...
\input Accelerator/AF05/bibliography.tex
