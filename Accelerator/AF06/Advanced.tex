...
%% IMPORTANT:   from this file, refer to the bibliography as Accelerator/AF06/bibliography.tex   
%%    refer to a figure   A.pdf  as    Accelerator/AF06/figures/A.pdf  .

\chapter{Advanced Accelerator Concepts}

\authorlist{R. Assman, C. Geddes, M. Hogan, P. Musumeci}
...
``No branch of Zoology is so much involved as that which is entitled Cetology,'' says Captain Scoresby, A.D. 1820~\cite{A6-Scoresby}.

``It is not my intention, were it in my power, to enter into the inquiry as to the true method of dividing the cetacea into groups and families. $\cdots$ Utter confusion exists among the historians of this animal'' (sperm whale), says Surgeon Beale, A.D. 1839~\cite{A6-Beale}.
...
%\bibliography{Accelerator/AF06/myreferences} 
...
\input Accelerator/AF06/bibliography.tex
