...
%% IMPORTANT:   from this file, refer to the bibliography as   Accelerator/AF07/bibliography.tex   
%%    refer to a figure   A.pdf  as    Accelerator/AF07/figures/A.pdf  .

\chapter{Beam Physics and Accelerator Education}

\authorlist{C. Barbier, S. Belomestnykh, S. Bermudez, E. Nanni, F. Pellemoine, G. Sabbi, Y.-E. Sun, H. Weise, S. Zlobin}
...
``No branch of Zoology is so much involved as that which is entitled Cetology,'' says Captain Scoresby, A.D. 1820~\cite{A7-Scoresby}.

``It is not my intention, were it in my power, to enter into the inquiry as to the true method of dividing the cetacea into groups and families. $\cdots$ Utter confusion exists among the historians of this animal'' (sperm whale), says Surgeon Beale, A.D. 1839~\cite{A7-Beale}.
...
%\bibliography{Accelerator/AF07/myreferences} 
...
\input Accelerator/AF07/bibliography.tex
