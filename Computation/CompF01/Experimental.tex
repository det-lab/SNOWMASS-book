...
%                                                          Computation/CompF01/bibliography.tex   
%%    refer to a figure   A.pdf  as    Computation/CompF01/figures/A.pdf  .

\chapter{Experimental Algorithms and Parallelization}

\authorlist{G. Certai, K. Heitmann, W. Hopkins}
...
``No branch of Zoology is so much involved as that which is entitled Cetology,'' says Captain Scoresby, A.D. 1820~\cite{Comp1-Scoresby}.

``It is not my intention, were it in my power, to enter into the inquiry as to the true method of dividing the cetacea into groups and families. $\cdots$ Utter confusion exists among the historians of this animal'' (sperm whale), says Surgeon Beale, A.D. 1839~\cite{Comp1-Beale}.
...
%\bibliography{Computation/CompF01/myreferences} 
...
\input Computation/CompF01/bibliography.tex
