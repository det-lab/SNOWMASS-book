...
%                                                          Computation/CompF02/bibliography.tex   
%%    refer to a figure   A.pdf  as    Computation/CompF02/figures/A.pdf  .

\chapter{Theoretical Computation and Simulations}

\authorlist{P. Boyle, V. D. Elvira, J. Qiang}
...
``No branch of Zoology is so much involved as that which is entitled Cetology,'' says Captain Scoresby, A.D. 1820~\cite{Comp2-Scoresby}.

``It is not my intention, were it in my power, to enter into the inquiry as to the true method of dividing the cetacea into groups and families. $\cdots$ Utter confusion exists among the historians of this animal'' (sperm whale), says Surgeon Beale, A.D. 1839~\cite{Comp2-Beale}.
...
%\bibliography{Computation/CompF02/myreferences} 
...
\input Computation/CompF02/bibliography.tex
