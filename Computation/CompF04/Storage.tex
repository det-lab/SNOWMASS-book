...
%                                                          Computation/CompF04/bibliography.tex   
%%    refer to a figure   A.pdf  as    Computation/CompF04/figures/A.pdf  .

\chapter{Storage and Processing Resources for Particle Physics Computing}
\authorlist{W. Bhimij, M. Lin, F. Wuerthwein}
...
``No branch of Zoology is so much involved as that which is entitled Cetology,'' says Captain Scoresby, A.D. 1820~\cite{Comp4-Scoresby}.

``It is not my intention, were it in my power, to enter into the inquiry as to the true method of dividing the cetacea into groups and families. $\cdots$ Utter confusion exists among the historians of this animal'' (sperm whale), says Surgeon Beale, A.D. 1839~\cite{Comp4-Beale}.
...
%\bibliography{Computation/CompF04/myreferences} 
...
\input Computation/CompF04/bibliography.tex
