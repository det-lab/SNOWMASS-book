...
%% IMPORTANT:   from this file, refer to the bibliography as   Cosmic/CF01/bibliography.tex   
%%    refer to a figure   A.pdf  as    Cosmic/CF01/figures/A.pdf  .

\chapter{Particle-Like Dark Matter}

\authorlist{J. Cooley, T. Lin, H. Lippincott, T. Slatyer}
...
``No branch of Zoology is so much involved as that which is entitled Cetology,'' says Captain Scoresby, A.D. 1820~\cite{C1-Scoresby}.

``It is not my intention, were it in my power, to enter into the inquiry as to the true method of dividing the cetacea into groups and families. $\cdots$ Utter confusion exists among the historians of this animal'' (sperm whale), says Surgeon Beale, A.D. 1839~\cite{C1-Beale}.
...
%\bibliography{Cosmic/CF01/myreferences} 
...
\input Cosmic/CF01/bibliography.tex
