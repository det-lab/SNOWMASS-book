...
%% IMPORTANT:   from this file, refer to the bibliography as   Cosmic/CF02/bibliography.tex   
%%    refer to a figure   A.pdf  as    Cosmic/CF02/figures/A.pdf  .

\chapter{Wave-Like Dark Matter}

\authorlist{J. Jaeckel, G. Rybka, L. Winslow}
...
``No branch of Zoology is so much involved as that which is entitled Cetology,'' says Captain Scoresby, A.D. 1820~\cite{C2-Scoresby}.

``It is not my intention, were it in my power, to enter into the inquiry as to the true method of dividing the cetacea into groups and families. $\cdots$ Utter confusion exists among the historians of this animal'' (sperm whale), says Surgeon Beale, A.D. 1839~\cite{C2-Beale}.
...
%\bibliography{Cosmic/CF02/myreferences} 
...
\input Cosmic/CF02/bibliography.tex
