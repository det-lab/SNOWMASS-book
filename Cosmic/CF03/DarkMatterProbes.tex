...
%% IMPORTANT:   from this file, refer to the bibliography as   Cosmic/CF03/bibliography.tex   
%%    refer to a figure   A.pdf  as    Cosmic/CF03/figures/A.pdf  .

\chapter{Cosmic Probes of Dark Matter}

\authorlist{A. Drlica-Wagner, C. Prescod-Weinstein, H.-B. Yu}
...
``No branch of Zoology is so much involved as that which is entitled Cetology,'' says Captain Scoresby, A.D. 1820~\cite{C3-Scoresby}.

``It is not my intention, were it in my power, to enter into the inquiry as to the true method of dividing the cetacea into groups and families. $\cdots$ Utter confusion exists among the historians of this animal'' (sperm whale), says Surgeon Beale, A.D. 1839~\cite{C3-Beale}.
...
%\bibliography{Cosmic/CF03/myreferences} 
...
\input Cosmic/CF03/bibliography.tex
