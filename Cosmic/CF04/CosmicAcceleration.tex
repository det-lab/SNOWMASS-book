...
%% IMPORTANT:   from this file, refer to the bibliography as   Cosmic/CF04/bibliography.tex   
%%    refer to a figure   A.pdf  as    Cosmic/CF04/figures/A.pdf  .

\chapter{Dark Energy and Cosmic Acceleration in the Modern Universe}

\authorlist{J. Annis, J. Newman, A. Slosar}
...
``No branch of Zoology is so much involved as that which is entitled Cetology,'' says Captain Scoresby, A.D. 1820~\cite{C4-Scoresby}.

``It is not my intention, were it in my power, to enter into the inquiry as to the true method of dividing the cetacea into groups and families. $\cdots$ Utter confusion exists among the historians of this animal'' (sperm whale), says Surgeon Beale, A.D. 1839~\cite{C4-Beale}.
...
%\bibliography{Cosmic/CF04/myreferences} 
...
\input Cosmic/CF04/bibliography.tex
