...
%% IMPORTANT:   from this file, refer to the bibliography as   Cosmic/CF05/bibliography.tex   
%%    refer to a figure   A.pdf  as    Cosmic/CF05/figures/A.pdf  .

\chapter{Dark Energy and Cosmic Acceleration in the Cosmic Dawn and Before}

\authorlist{C. Chang, L Newburgh, D. Shoemaker}
...
``No branch of Zoology is so much involved as that which is entitled Cetology,'' says Captain Scoresby, A.D. 1820~\cite{C5-Scoresby}.

``It is not my intention, were it in my power, to enter into the inquiry as to the true method of dividing the cetacea into groups and families. $\cdots$ Utter confusion exists among the historians of this animal'' (sperm whale), says Surgeon Beale, A.D. 1839~\cite{C5-Beale}.
...
%\bibliography{Cosmic/CF05/myreferences} 
...
\input Cosmic/CF05/bibliography.tex
