...
%% IMPORTANT:   from this file, refer to the bibliography as   Cosmic/CF07/bibliography.tex   
%%    refer to a figure   A.pdf  as    Cosmic/CF07/figures/A.pdf  .

\chapter{Cosmic Probes of Fundamental Physics}

\authorlist{R. Adhikari, L. Anchordoqui, K. Fang, B.~S. Sathyaprakash, K. Tollefson}
...
``No branch of Zoology is so much involved as that which is entitled Cetology,'' says Captain Scoresby, A.D. 1820~\cite{C7-Scoresby}.

``It is not my intention, were it in my power, to enter into the inquiry as to the true method of dividing the cetacea into groups and families. $\cdots$ Utter confusion exists among the historians of this animal'' (sperm whale), says Surgeon Beale, A.D. 1839~\cite{C7-Beale}.
...
%\bibliography{Cosmic/CF07/myreferences} 
...
\input Cosmic/CF07/bibliography.tex
