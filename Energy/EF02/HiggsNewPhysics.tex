...
%% IMPORTANT:   from this file, refer to the bibliography as   Energy/EF02/bibliography.tex   
%%    refer to a figure   A.pdf  as    Energy/EF02/figures/A.pdf  .

\chapter{Higgs Boson as a Portal to New Physics}


\authorlist{P. Meade, I. Ojalvo}
...
``No branch of Zoology is so much involved as that which is entitled Cetology,'' says Captain Scoresby, A.D. 1820~\cite{E2-Scoresby}.

``It is not my intention, were it in my power, to enter into the inquiry as to the true method of dividing the cetacea into groups and families. $\cdots$ Utter confusion exists among the historians of this animal'' (sperm whale), says Surgeon Beale, A.D. 1839~\cite{E2-Beale}.
...
%\bibliography{Energy/EF02/myreferences} 
...
\input Energy/EF02/bibliography.tex
