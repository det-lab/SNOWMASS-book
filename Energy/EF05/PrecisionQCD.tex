...
%% IMPORTANT:   from this file, refer to the bibliography as   Energy/EF05/bibliography.tex   
%%    refer to a figure   A.pdf  as    Energy/EF015/figures/A.pdf  .

\chapter{QCD and Strong Interactions: Precision QCD}

\authorlist{M. Begel, S. Hoeche, M. Schmitt}
...
``No branch of Zoology is so much involved as that which is entitled Cetology,'' says Captain Scoresby, A.D. 1820~\cite{E5-Scoresby}.

``It is not my intention, were it in my power, to enter into the inquiry as to the true method of dividing the cetacea into groups and families. $\cdots$ Utter confusion exists among the historians of this animal'' (sperm whale), says Surgeon Beale, A.D. 1839~\cite{E5-Beale}.
...
%\bibliography{Energy/EF05/myreferences} 
...
\input Energy/EF05/bibliography.tex
