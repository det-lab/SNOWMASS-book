...
%% IMPORTANT:   from this file, refer to the bibliography as   Energy/EF09/bibliography.tex   
%%    refer to a figure   A.pdf  as    Energy/EF09/figures/A.pdf  .

\chapter{Beyond the Standard Model: General Explorations}

\authorlist{T. Bose, Z. Liu, S. Pagan Griso}
...
``No branch of Zoology is so much involved as that which is entitled Cetology,'' says Captain Scoresby, A.D. 1820~\cite{E9-Scoresby}.

``It is not my intention, were it in my power, to enter into the inquiry as to the true method of dividing the cetacea into groups and families. $\cdots$ Utter confusion exists among the historians of this animal'' (sperm whale), says Surgeon Beale, A.D. 1839~\cite{E9-Beale}.
...
%\bibliography{Energy/EF09/myreferences} 
...
\input Energy/EF09/bibliography.tex
