...
%% IMPORTANT:   from this file, refer to the bibliography as   Energy/EF10/bibliography.tex   
%%    refer to a figure   A.pdf  as    Energy/EF10/figures/A.pdf  .

\chapter{Beyond the Standard Model: Dark Matter at Colliders}
\authorlist{C. Doglioni, L.-T. Wang}
...
``No branch of Zoology is so much involved as that which is entitled Cetology,'' says Captain Scoresby, A.D. 1820~\cite{E10-Scoresby}.

``It is not my intention, were it in my power, to enter into the inquiry as to the true method of dividing the cetacea into groups and families. $\cdots$ Utter confusion exists among the historians of this animal'' (sperm whale), says Surgeon Beale, A.D. 1839~\cite{E10-Beale}.
...
%\bibliography{Energy/EF10/myreferences} 
...
\input Energy/EF10/bibliography.tex
