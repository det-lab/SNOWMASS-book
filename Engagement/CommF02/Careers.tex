...
%% IMPORTANT:   from this file, refer to the bibliography as   Engagement/CommF02/bibliography.tex   
%%    refer to a figure   A.pdf  as    Engagement/CommF02/figures/A.pdf  .

\chapter{Career Pipeline and Development in Particle Physics}

\authorlist{J. Hogan, A. Karadzhinova-Ferrer, S. Malik}
...
``No branch of Zoology is so much involved as that which is entitled Cetology,'' says Captain Scoresby, A.D. 1820~\cite{Comm2-Scoresby}.

``It is not my intention, were it in my power, to enter into the inquiry as to the true method of dividing the cetacea into groups and families. $\cdots$ Utter confusion exists among the historians of this animal'' (sperm whale), says Surgeon Beale, A.D. 1839~\cite{Comm2-Beale}.
...
%\bibliography{Engagement/CommF02/myreferences} 
...
\input Engagement/CommF02/bibliography.tex
