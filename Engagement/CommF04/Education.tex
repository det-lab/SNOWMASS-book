...
%% IMPORTANT:   from this file, refer to the bibliography as   Engagement/CommF04/bibliography.tex   
%%    refer to a figure   A.pdf  as    Engagement/CommF04/figures/A.pdf  .

\chapter{Physics Education}

\authorlist{S. de Jong, S. Malik, R. Ruchti}
...
``No branch of Zoology is so much involved as that which is entitled Cetology,'' says Captain Scoresby, A.D. 1820~\cite{Comm4-Scoresby}.

``It is not my intention, were it in my power, to enter into the inquiry as to the true method of dividing the cetacea into groups and families. $\cdots$ Utter confusion exists among the historians of this animal'' (sperm whale), says Surgeon Beale, A.D. 1839~\cite{Comm4-Beale}.
...
%\bibliography{Engagement/CommF04/myreferences} 
...
\input Engagement/CommF04/bibliography.tex
