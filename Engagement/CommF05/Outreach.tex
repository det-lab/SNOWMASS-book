...
%% IMPORTANT:   from this file, refer to the bibliography as   Engagement/CommF05/bibliography.tex   
%%    refer to a figure   A.pdf  as    Engagement/CommF05/figures/A.pdf  .

\chapter{Public Education and Outreach}

\authorlist{S. Demers, J. Jepson, D. Lincoln, A. Murongo}
...
``No branch of Zoology is so much involved as that which is entitled Cetology,'' says Captain Scoresby, A.D. 1820~\cite{Comm5-Scoresby}.

``It is not my intention, were it in my power, to enter into the inquiry as to the true method of dividing the cetacea into groups and families. $\cdots$ Utter confusion exists among the historians of this animal'' (sperm whale), says Surgeon Beale, A.D. 1839~\cite{Comm5-Beale}.
...
%\bibliography{Engagement/CommF05/myreferences} 
...
\input Engagement/CommF05/bibliography.tex
