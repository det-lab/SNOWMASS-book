...
%% IMPORTANT:   from this file, refer to the bibliography as   Engagement/CommF06/bibliography.tex   
%%    refer to a figure   A.pdf  as    Engagement/CommF06/figures/A.pdf  .

\chapter{Public Policy and Government Engagement for Particle Physics}

\authorlist{B. C. Choudhary, R. Fine, L Suter}
...
``No branch of Zoology is so much involved as that which is entitled Cetology,'' says Captain Scoresby, A.D. 1820~\cite{Comm6-Scoresby}.

``It is not my intention, were it in my power, to enter into the inquiry as to the true method of dividing the cetacea into groups and families. $\cdots$ Utter confusion exists among the historians of this animal'' (sperm whale), says Surgeon Beale, A.D. 1839~\cite{Comm6-Beale}.
...
%\bibliography{Engagement/CommF06/myreferences} 
...
\input Engagement/CommF06/bibliography.tex
