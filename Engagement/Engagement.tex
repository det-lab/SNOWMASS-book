...
\chapter{Community Engagement Frontier}

\authorlist{K.~A.~Assamagan, B.~Quinn}
{K.~Bloom, V.~Boisvert, C.~Bonifazi, J.~S.~Bonilla, M.-C.~Chen,  B.~C.~Choudhary, F.~Fahim, S.~Demers, R.~Fine, 
M.~Headley,  J.~Hogan, K.~Jepsen,  S.~de~Jong,
 A.~Karadzhinova-Ferrer, Y.-H.~C.~Lin, D.~Lincoln,  S.~Malik,  A.~Murokh,  A.~Murongo,
R.~Ruchti,  L.~Suter, K.~Yoshimura}
...
``No branch of Zoology is so much involved as that which is entitled Cetology,'' says Captain Scoresby, A.D. 1820~\cite{EN-Scoresby}.

``It is not my intention, were it in my power, to enter into the inquiry as to the true method of dividing the cetacea into groups and families. $\cdots$ Utter confusion exists among the historians of this animal'' (sperm whale), says Surgeon Beale, A.D. 1839~\cite{EN-Beale}.
...
%\bibliography{Engagement/myreferences} 
...
\input Engagement/bibliography.tex
