...
%% IMPORTANT:   from this file, refer to the bibliography as   Instrumentation/IF10/bibliography.tex   
%%    refer to a figure   A.pdf  as    Instrumentation/IF10/figures/A.pdf  .

\chapter{Radio Detection}

\authorlist{A. Connolly, A. Karle}
...
``No branch of Zoology is so much involved as that which is entitled Cetology,'' says Captain Scoresby, A.D. 1820~\cite{I10-Scoresby}.

``It is not my intention, were it in my power, to enter into the inquiry as to the true method of dividing the cetacea into groups and families. $\cdots$ Utter confusion exists among the historians of this animal'' (sperm whale), says Surgeon Beale, A.D. 1839~\cite{I10-Beale}.
...
%\bibliography{Instrumentation/IF10/myreferences} 
...
\input Instrumentation/IF10/bibliography.tex
