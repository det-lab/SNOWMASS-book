...
%% IMPORTANT:   from this file, refer to the bibliography as   Neutrino/NF04/bibliography.tex   
%%    refer to a figure   A.pdf  as    Neutrino/NF04/figures/A.pdf  .

\chapter{Neutrinos from Natural Sources}

\authorlist{Y. Koshio, G. D. Orebi Gann, E. O'Sullivan, I. Tamborra}
...
``No branch of Zoology is so much involved as that which is entitled Cetology,'' says Captain Scoresby, A.D. 1820~\cite{N4-Scoresby}.

``It is not my intention, were it in my power, to enter into the inquiry as to the true method of dividing the cetacea into groups and families. $\cdots$ Utter confusion exists among the historians of this animal'' (sperm whale), says Surgeon Beale, A.D. 1839~\cite{N4-Beale}.
...
%\bibliography{Neutrino/NF04/myreferences} 
...
\input Neutrino/NF04/bibliography.tex
