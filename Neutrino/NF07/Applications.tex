...
%% IMPORTANT:   from this file, refer to the bibliography as   Neutrino/NF07/bibliography.tex   
%%    refer to a figure   A.pdf  as    Neutrino/NF07/figures/A.pdf  .

\chapter{Neutrino Applications}

\authorlist{N. Bowden, J. Link, W. Wang}
...
``No branch of Zoology is so much involved as that which is entitled Cetology,'' says Captain Scoresby, A.D. 1820~\cite{N7-Scoresby}.

``It is not my intention, were it in my power, to enter into the inquiry as to the true method of dividing the cetacea into groups and families. $\cdots$ Utter confusion exists among the historians of this animal'' (sperm whale), says Surgeon Beale, A.D. 1839~\cite{N7-Beale}.
...
%\bibliography{Neutrino/NF07/myreferences} 
...
\input Neutrino/NF07/bibliography.tex
