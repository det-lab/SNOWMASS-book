...
%% IMPORTANT:   from this file, refer to the bibliography as   Rare/RF01/bibliography.tex   
%%    refer to a figure   A.pdf  as    Rare/RF01/figures/A.pdf  .

\chapter{Weak Decays of $b$ and $c$ Quarks}

\authorlist{A. Di Canto, S. Meinel}
...
``No branch of Zoology is so much involved as that which is entitled Cetology,'' says Captain Scoresby, A.D. 1820~\cite{R1-Scoresby}.

``It is not my intention, were it in my power, to enter into the inquiry as to the true method of dividing the cetacea into groups and families. $\cdots$ Utter confusion exists among the historians of this animal'' (sperm whale), says Surgeon Beale, A.D. 1839~\cite{R1-Beale}.
...
%\bibliography{RARE/RF01/myreferences} 
...
\input Rare/RF01/bibliography.tex
