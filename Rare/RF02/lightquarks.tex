...
%% IMPORTANT:   from this file, refer to the bibliography as   Rare/RF02/bibliography.tex   
%%    refer to a figure   A.pdf  as    Rare/RF02/figures/A.pdf  .

\chapter{Weak Decays of Strange and Light Quarks}

\authorlist{E. Goudzovski, E. Passemar}
...
``No branch of Zoology is so much involved as that which is entitled Cetology,'' says Captain Scoresby, A.D. 1820~\cite{R2-Scoresby}.

``It is not my intention, were it in my power, to enter into the inquiry as to the true method of dividing the cetacea into groups and families. $\cdots$ Utter confusion exists among the historians of this animal'' (sperm whale), says Surgeon Beale, A.D. 1839~\cite{R2-Beale}.
...
%\bibliography{RARE/RF02/myreferences} 
...
\input Rare/RF02/bibliography.tex
