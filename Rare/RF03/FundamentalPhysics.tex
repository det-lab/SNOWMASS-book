...
%% IMPORTANT:   from this file, refer to the bibliography as   Rare/RF03/bibliography.tex   
%%    refer to a figure   A.pdf  as    Rare/RF03/figures/A.pdf  .

\chapter{Fundamental Physics in Small Experiments}

\authorlist{P. Winter, T. Blum}
...
``No branch of Zoology is so much involved as that which is entitled Cetology,'' says Captain Scoresby, A.D. 1820~\cite{R3-Scoresby}.

``It is not my intention, were it in my power, to enter into the inquiry as to the true method of dividing the cetacea into groups and families. $\cdots$ Utter confusion exists among the historians of this animal'' (sperm whale), says Surgeon Beale, A.D. 1839~\cite{R3-Beale}.
...
%\bibliography{RARE/RF03/myreferences} 
...
\input Rare/RF03/bibliography.tex
