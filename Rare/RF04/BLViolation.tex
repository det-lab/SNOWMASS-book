...
%% IMPORTANT:   from this file, refer to the bibliography as   Rare/RF04/bibliography.tex   
%%    refer to a figure   A.pdf  as    Rare/RF04/figures/A.pdf  .

\chapter{Baryon and Lepton Number Violation}

\authorlist{P. Fileviez Perez, A. Pocar}
...
``No branch of Zoology is so much involved as that which is entitled Cetology,'' says Captain Scoresby, A.D. 1820~\cite{R4-Scoresby}.

``It is not my intention, were it in my power, to enter into the inquiry as to the true method of dividing the cetacea into groups and families. $\cdots$ Utter confusion exists among the historians of this animal'' (sperm whale), says Surgeon Beale, A.D. 1839~\cite{R4-Beale}.
...
%\bibliography{RARE/RF04/myreferences} 
...
\input Rare/RF04/bibliography.tex
