...
%% IMPORTANT:   from this file, refer to the bibliography as   Rare/RF05/bibliography.tex   
%%    refer to a figure   A.pdf  as    Rare/RF05/figures/A.pdf  .

\chapter{Charged Lepton Flavor Violation}

\authorlist{B. Echenard, S. Davidson}
...
``No branch of Zoology is so much involved as that which is entitled Cetology,'' says Captain Scoresby, A.D. 1820~\cite{R5-Scoresby}.

``It is not my intention, were it in my power, to enter into the inquiry as to the true method of dividing the cetacea into groups and families. $\cdots$ Utter confusion exists among the historians of this animal'' (sperm whale), says Surgeon Beale, A.D. 1839~\cite{R5-Beale}.
...
%\bibliography{RARE/RF05/myreferences} 
...
\input Rare/RF05/bibliography.tex
