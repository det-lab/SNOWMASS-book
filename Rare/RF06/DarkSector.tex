...
%% IMPORTANT:   from this file, refer to the bibliography as   Rare/RF06/bibliography.tex   
%%    refer to a figure   A.pdf  as    Rare/RF06/figures/A.pdf  .

\chapter{Dark Sector at High Intensities}

\authorlist{M. Williams, S. Gori}
...
``No branch of Zoology is so much involved as that which is entitled Cetology,'' says Captain Scoresby, A.D. 1820~\cite{R6-Scoresby}.

``It is not my intention, were it in my power, to enter into the inquiry as to the true method of dividing the cetacea into groups and families. $\cdots$ Utter confusion exists among the historians of this animal'' (sperm whale), says Surgeon Beale, A.D. 1839~\cite{R6-Beale}.
...
%\bibliography{RARE/RF06/myreferences} 
...
\input Rare/RF06/bibliography.tex
