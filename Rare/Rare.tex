...
\chapter{Rare Processes and Precision Measurements}

\authorlist{M. Artuso, R. Bernstein, A. A. Petrov}
   {T. Blum, A.~Di~Canto, S. Davidson, B.~Echenard,  P.~Fileviez~Perez, S.~Gori, 
E.~Goudzovski, R.~Lebed, S.~Meinel, E.~Passemar, A.~Pocar, T.~Skwarnicki, M.~Williams, P.~Winter}
...
``No branch of Zoology is so much involved as that which is entitled Cetology,'' says Captain Scoresby, A.D. 1820~\cite{R-Scoresby}.

``It is not my intention, were it in my power, to enter into the inquiry as to the true method of dividing the cetacea into groups and families. $\cdots$ Utter confusion exists among the historians of this animal'' (sperm whale), says Surgeon Beale, A.D. 1839~\cite{R-Beale}.
...
%\bibliography{Rare/myreferences} 
