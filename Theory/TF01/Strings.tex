...
%% IMPORTANT:   from this file, refer to the bibliography as Theory/TF01/bibliography.tex   
%%    refer to a figure   A.pdf  as   Theory/TF01/figures/A.pdf  .

\chapter{String Theory, Quantum Gravity, and Black Holes}

\authorlist{D. Harlow, S. Kachru, J. Maldacena}
...
``No branch of Zoology is so much involved as that which is entitled Cetology,'' says Captain Scoresby, A.D. 1820~\cite{T1-Scoresby}.

``It is not my intention, were it in my power, to enter into the inquiry as to the true method of dividing the cetacea into groups and families. $\cdots$ Utter confusion exists among the historians of this animal'' (sperm whale), says Surgeon Beale, A.D. 1839~\cite{T1-Beale}.
...
%\bibliography{Theory/TF01/myreferences} 
...
\input Theory/TF01/bibliography.tex
