...
%% IMPORTANT:   from this file, refer to the bibliography as Theory/TF04/bibliography.tex   
%%    refer to a figure   A.pdf  as   Theory/TF04/figures/A.pdf  .

\chapter{Theory of Scattering Amplitudes}

\authorlist{Z. Bern, J. Trnka}
...
``No branch of Zoology is so much involved as that which is entitled Cetology,'' says Captain Scoresby, A.D. 1820~\cite{T4-Scoresby}.

``It is not my intention, were it in my power, to enter into the inquiry as to the true method of dividing the cetacea into groups and families. $\cdots$ Utter confusion exists among the historians of this animal'' (sperm whale), says Surgeon Beale, A.D. 1839~\cite{T4-Beale}.
...
%\bibliography{Theory/TF04/myreferences} 
...
\input Theory/TF04/bibliography.tex
