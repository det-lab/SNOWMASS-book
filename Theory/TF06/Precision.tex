...
%% IMPORTANT:   from this file, refer to the bibliography as Theory/TF06/bibliography.tex   
%%    refer to a figure   A.pdf  as   Theory/TF06/figures/A.pdf  .

\chapter{Theory Techniques for Precision Physics Calculation}
\authorlist{R. Boughezal, Z. Ligeti}
...
``No branch of Zoology is so much involved as that which is entitled Cetology,'' says Captain Scoresby, A.D. 1820~\cite{T6-Scoresby}.

``It is not my intention, were it in my power, to enter into the inquiry as to the true method of dividing the cetacea into groups and families. $\cdots$ Utter confusion exists among the historians of this animal'' (sperm whale), says Surgeon Beale, A.D. 1839~\cite{T6-Beale}.
...
%\bibliography{Theory/TF06/myreferences} 
...
\input Theory/TF06/bibliography.tex
