...
%% IMPORTANT:   from this file, refer to the bibliography as Theory/TF09/bibliography.tex   
%%    refer to a figure   A.pdf  as   Theory/TF09/figures/A.pdf  .

\chapter{Theory of Astro-Particle Physics and Cosmology}

\authorlist{D. Green, J. Ruderman, B. Safdi, J. Shelton}
...
``No branch of Zoology is so much involved as that which is entitled Cetology,'' says Captain Scoresby, A.D. 1820~\cite{T9-Scoresby}.

``It is not my intention, were it in my power, to enter into the inquiry as to the true method of dividing the cetacea into groups and families. $\cdots$ Utter confusion exists among the historians of this animal'' (sperm whale), says Surgeon Beale, A.D. 1839~\cite{T9-Beale}.
...
%\bibliography{Theory/TF09/myreferences} 
...
\input Theory/TF09/bibliography.tex
