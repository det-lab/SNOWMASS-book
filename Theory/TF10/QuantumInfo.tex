...
%% IMPORTANT:   from this file, refer to the bibliography as Theory/TF10/bibliography.tex   
%%    refer to a figure   A.pdf  as   Theory/TF10/figures/A.pdf  .

\chapter{Quantum Information Science}
\authorlist{S. Catterall, R. Harnik, V. Hubeny}
...
``No branch of Zoology is so much involved as that which is entitled Cetology,'' says Captain Scoresby, A.D. 1820~\cite{T10-Scoresby}.

``It is not my intention, were it in my power, to enter into the inquiry as to the true method of dividing the cetacea into groups and families. $\cdots$ Utter confusion exists among the historians of this animal'' (sperm whale), says Surgeon Beale, A.D. 1839~\cite{T10-Beale}.
...
%\bibliography{Theory/TF10/myreferences} 
...
\input Theory/TF10/bibliography.tex
