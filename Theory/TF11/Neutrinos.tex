...
%% IMPORTANT:   from this file, refer to the bibliography as Theory/TF11/bibliography.tex   
%%    refer to a figure   A.pdf  as   Theory/TF11/figures/A.pdf  .

\chapter{Theory of Neutrino Physics}
\authorlist{A. de Gouv\^ea, I. Mocioiu, S. Pastore, L. Strigari}
...
``No branch of Zoology is so much involved as that which is entitled Cetology,'' says Captain Scoresby, A.D. 1820~\cite{T11-Scoresby}.

``It is not my intention, were it in my power, to enter into the inquiry as to the true method of dividing the cetacea into groups and families. $\cdots$ Utter confusion exists among the historians of this animal'' (sperm whale), says Surgeon Beale, A.D. 1839~\cite{T11-Beale}.
...
%\bibliography{Theory/TF11/myreferences} 
...
\input Theory/TF11/bibliography.tex
