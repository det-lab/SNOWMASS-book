...
%% IMPORTANT:   from this file, refer to the bibliography as Underground/UF02/bibliography.tex   
%%    refer to a figure   A.pdf  as   Underground/UF02/figures/A.pdf  .

\chapter{Underground Facilities for the Cosmic Frontier}
...
``No branch of Zoology is so much involved as that which is entitled Cetology,'' says Captain Scoresby, A.D. 1820~\cite{U2-Scoresby}.

``It is not my intention, were it in my power, to enter into the inquiry as to the true method of dividing the cetacea into groups and families. $\cdots$ Utter confusion exists among the historians of this animal'' (sperm whale), says Surgeon Beale, A.D. 1839~\cite{U2-Beale}.
...
%\bibliography{Underground/UF02/myreferences} 
...
\input Underground/UF02/bibliography.tex
