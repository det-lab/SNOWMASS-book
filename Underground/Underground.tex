...
\chapter{Underground Facilities}

\authorlist{L.~Baudis, J.~Hall, K.~Lesko, J.~Orrell}
{(topical group conveners are not listed on the Snowmass wiki)}
...
%\bibliography{Underground/myreferences} 
...
\input Underground/bibliography.tex
